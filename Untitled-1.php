...
if(isset($_POST['submit'])){
  ...
  $mail->SMTPAuth=true;
  $mail->SMTPSecure='tls';
  $mail->Username='softwaresolution950@gmail.com';
  $mail->Password='Hacker@143';

  $mail->setFrom($_POST['email'],$_POST['name']);
  $mail->addAddress('softwaresolution950@gmail.com');
                    ...
                    <form class="row form wrapper d-block text-lg-start" action="#" method="post" id="form-box">
                        ...
                        <div class="row ">
                            <div class="col-md-12 col-xs-12 form-group ">
                                ...
                                <textarea name="msg " id="msg " class="message form-control " placeholder="Write message " cols="30 " rows="4 " required></textarea></br>

                            </div>
                            </br>

                            <!-- /.form-group -->
                            <input class="btn btn-sm btn-primary " name="submit " id="submit " type="submit " value="Send Message " style="width: 150px;
                        height: 50px;
                        font-size: larger;
                        font-weight: bold;
                        border-radius: 10px;
